...
namespace LibraryTests
{
    ...
    public class MovimientoTests
    {
        ...
        {
            var movimientoDormir = new Movimiento("Dormir", 0, 100,"Psíquico", true);
        ...
        {
            var movimientoQuemar = new Movimiento("Quemar", 0,100, "Fuego", true);
        ...
        {
            var movimientoParalizar = new Movimiento("Paralizar", 0, 100,"Eléctrico", true);
        ...
        {
            var movimientoEnvenenar = new Movimiento("Envenenar", 0, 100,"Veneno", true);
        ...
        {
            var movimientoNormal = new Movimiento("Lanzallamas", 20, 60,"Fuego", false);
